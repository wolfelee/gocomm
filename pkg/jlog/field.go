...
func FieldCost(value time.Duration) Field {
	return Int64("cost", int64(float64(value.Round(time.Microsecond))/float64(time.Millisecond)))
}
...
func FieldStack(value []byte) Field {
	return ByteString("s", value) //stack
}

// FieldMethod ...
func FieldMethod(value string) Field {
	return String("m", value) //method
}

// FieldEvent ...
func FieldEvent(value string) Field {
	return String("e", value) //event
}

func FieldAction(value string) Field {
	return String("a", value) //action
}
